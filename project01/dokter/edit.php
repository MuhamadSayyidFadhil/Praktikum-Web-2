...
if (isset($_POST['submit'])) {
    ...
    $stmt = $dbh->prepare($sql);
    $stmt->execute($data);
    echo "<script>window.location.href = 'index_dokter.php';</script>";
}
?>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h2 class="text-center">Update Dokter</h2>
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="kategori" name="kategori" type="select" class="form-control" value="<?= $row['kategori'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
