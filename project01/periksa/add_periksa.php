...
if (isset($_POST["submit"])) {
    ...
    $stmt->execute($data);
    echo "<script>window.location.href = 'index_periksa.php';</script>";
}
?>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="add_periksa.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="keterangan" name="keterangan" type="name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="pasien" class="col-4 col-form-label">Pasien ID</label>
                                    <div class="col-8">
                                        <?php
                                ...
                                <div class="form-group row">
                                    <label for="dokter" class="col-4 col-form-label">Dokter ID</label>
                                    <div class="col-8">
                                        <?php
